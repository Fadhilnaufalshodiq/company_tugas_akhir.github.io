...
<head>
    ...
    <title>FR-Florist</title>

    <!-- navbar -->
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow shadow-sm fixed-top fy-3">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#"><span class="primary">FR</span>-Florist</a>
    ...
    <div class="services bg-light py-5">
        <div class="container">
            ...
            <p class="text-center mt-4">
                Pilihan Paket <br>
                Kami menyediakan paket pengadaan tanaman baik dalam bentuk sewa maupun perawatan. Paket yang kami
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm text-center p-4 mt-3" data-aos="zoom-in">
                        <div class="card-body">
                            <!-- Service Icon -->
                            <div class="card-icon mb-3">
                                @if(!empty($service->image))
                                <img src="{{ asset('image/' . $service->image) }}" alt="{{$service->title}}"
                            ...
                            <!-- Service Title -->
                            <div class="card-title fw-bolder mt-2">
                                {{$service->title}}
                            </div>
                            <!-- Service Description -->
                            <p class="card-description mt-3 text-muted">
                                {{$service->description}}
                            </p>
                        </div>
                    </div>
        ...
        <div class="footer-down bg-darker text-white px-5 py-3">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="copyright">
                            &copy; Copyright <strong>FR-Florist</strong>. All Right Reserved
                        </div>
                        <div class="credits">
                            Design by me
                        </div>
